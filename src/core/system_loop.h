...
#define SAFETY_CHECK_INTERVAL_MS 500
     ...
     * This function contains the main system loop and will run indefinitely
     * until the system is requested to stop.
     */
    void run_main_loop(void);

    /**
     * @brief Request the main loop to stop
     * This function sets a flag that will cause run_main_loop() to exit
     ...
     * This includes reading sensors, updating displays, logging status, etc.
     */
